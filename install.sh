...
linux_install_installer() {
    ...
    git clone -b feat/devnet https://github.com/OpenFusionist/EthPillar-Endurance.git ~/git/ethpillar/ 2> /dev/null || (cd ~/git/ethpillar && git fetch origin feat/devnet && git checkout feat/devnet && git pull)
