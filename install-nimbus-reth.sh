...
linux_install_validator-install() {
    ...
    git clone https://github.com/OpenFusionist/EthPillar-Endurance.git ~/git/ethpillar 2> /dev/null || (cd ~/git/ethpillar ; git fetch origin main ; git checkout main ; git pull)
